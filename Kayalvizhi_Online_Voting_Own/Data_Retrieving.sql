...
BEGIN
SELECT AADHAAR,PASSWORD INTO U_USER_ID,U_PASSWORD FROM VOTER WHERE AADHAAR = V_USER_ID;
...
BEGIN
SELECT ELECTION_ID INTO V_ELECTION_ID FROM ELECTION WHERE ELECTION_TYPE = 'MLA';
...
BEGIN
SELECT ELECTION_ID,ELECTION_DATE INTO V_ELECTION_ID,V_ELECTION_DATE FROM ELECTION WHERE ELECTION_TYPE = 'MLA';
DBMS_OUTPUT.PUT_LINE(V_ELECTION_ID);
END;
...
SELECT ELECTION_TYPE FROM ELECTION WHERE ELECTION_DATE = '08-MAR-22';
