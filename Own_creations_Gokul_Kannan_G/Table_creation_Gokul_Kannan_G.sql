...
RESULT_DATE 		DATE 		         	NOT NULL,
                 			CONSTRAINT ELECTION_ID_PK
PRIMARY KEY(ELECTION_ID));


CREATE TABLE STATE_NAME(STATE_ID	NUMBER,
STATE_NAME 	VARCHAR(50) UNIQUE NOT NULL,
                			CONSTRAINT STATE_ID_PK2 PRIMARY KEY(STATE_ID));
...
CONSTRAINT STATE_ID_FK FOREIGN KEY(STATE_ID) REFERENCES STATE_NAME(STATE_ID) ON DELETE CASCADE);


CREATE TABLE DISTRICT_INFO(DISTRICT_ID 	NUMBER             NOT NULL,
DISTRICT_NAME 	VARCHAR(32),
TOTAL_POPULATION 	NUMBER	NOT NULL,	CONSTRAINT	DISTRICT_NAME_PK	
...
CONSTITUENCY_ID 	NUMBER,
                			CONSTRAINT	CONSTITUENCY_ID_PK	
PRIMARY KEY(CONSTITUENCY_ID),
                			CONSTRAINT DISTRICT_ID_CONS_FK FOREIGN KEY(DISTRICT_ID) 
...
CONSTITUENCY_NAME 		VARCHAR(32),
               				TOTAL_POPULATION 		NUMBER	NOT NULL,					CONSTRAINT	CONSTITUENCY_NAME_PK	
PRIMARY KEY(CONSTITUENCY_NAME),
               				CONSTRAINT	CONSTITUENCY_ID_FK
...
CREATE TABLE CANDIDATE_PARTY (PARTY_ID 	NUMBER,
                                SYMBOL 	VARCHAR(30)	UNIQUE  NOT NULL,
                               CONSTRAINT CAN_PAR_PARTY_ID_PK PRIMARY KEY 
                               (PARTY_ID) , 
                    CONSTRAINT CAN_PAR_PARTY_ID_FK  FOREIGN KEY(PARTY_ID) 
                    REFERENCES PARTY(PARTY_ID) ON DELETE CASCADE); 
           

   	CREATE TABLE CANDIDATE(CANDIDATE_ID   	NUMBER,
CANDIDATETYPE_ID 	NUMBER               NOT NULL,
AADHAAR                            NUMBER                NOT NULL,
NAME			VARCHAR(32)        NOT NULL,
ELECTION_ID		VARCHAR(32)        NOT NULL,
PARTY_ID		NUMBER                 NOT NULL,
                			CONSTRAINT	CANDIDATE_ID_PK	
PRIMARY KEY(CANDIDATE_ID),
                			CONSTRAINT     CANDIDATETYPE_ID_FK 
   				FOREIGN KEY (CANDIDATETYPE_ID) REFERENCES 
                                                         CANDIDATE_TYPE(CANDIDATETYPE_ID),
 				CONSTRAINT      CAN_AADHAR_FK
				FOREIGN KEY(AADHAAR) REFERENCES ADDRESS(AADHAAR),
				CONSTRAINT      CAN_ELECTION_ID_FK
				FOREIGN KEY(ELECTION_ID) REFERENCES ELECTION(ELECTION_ID),
				CONSTRAINT      CAN_PARTY_ID_FK
...
CREATE TABLE CANDIDATE_TYPE (CANDIDATETYPE_ID 	NUMBER,
                  ...
                  CONSTRAINT CANDIDATETYPE_ID_PK 
                   PRIMARY KEY(CANDIDATETYPE_ID)) ;
...
LAST_NAME  	VARCHAR(32)	NOT NULL,
	VOTER_ID	NUMBER,
CONSTRAINT VOTER_ID_PK  PRIMARY KEY(VOTER_ID),
DATE_OF_BIRTH    DATE     	NOT NULL,
AGE                     NUMBER              NOT NULL,
AADHAAR	NUMBER	UNIQUE NOT NULL,
...
PASSWORD	VARCHAR(20)	UNIQUE NOT NULL);
	...
	CREATE TABLE  ADDRESS(AADHAAR		NUMBER,
				STATE_ID		NUMBER     NOT NULL,
				DISTRICT_ID		NUMBER     NOT NULL,
				CONSTITUENCY_ID	NUMBER     NOT NULL,
				ZIP_CODE		NUMBER     NOT NULL,
				PHONE_NUMBER	NUMBER     NOT NULL,
CONSTRAINT AADHAAR_PK  PRIMARY KEY(AADHAAR),
CONSTRAINT STATE_ID_FKA FOREIGN KEY(STATE_ID) REFERENCES STATE_NAME(STATE_ID) ON DELETE CASCADE,
CONSTRAINT	ADD_DISTRICT_ID_FK
FOREIGN KEY(DISTRICT_ID) REFERENCES DISTRICT(DISTRICT_ID)
               			ON DELETE CASCADE,
				CONSTRAINT	ADDA_CONSTITUENCY_ID_FK
FOREIGN KEY(CONSTITUENCY_ID) 
                			REFERENCES CONSTITUENCY(CONSTITUENCY_ID) 
ON DELETE CASCADE ,
				CONSTRAINT	ADAD_ZIP_CODE_FK
...
CREATE TABLE VOTE_POOLING     (AADHAAR    NUMBER                 NOT NULL,
                                                              ELECTION_ID VARCHAR(32)             NOT NULL,
                                 CANDIDATE_ID NUMBER                  NOT NULL,
                                 CONSTRAINT VOTE_POOL_AADHAR_FK 
                                 FOREIGN KEY(AADHAAR)
                                 REFERENCES ADDRESS(AADHAAR) 
                                 ON DELETE CASCADE,
                                 CONSTRAINT VOTE_POOL_ELECTION_ID_FK 
                                 FOREIGN KEY(ELECTION_ID) 
                                 REFERENCES ELECTION(ELECTION_ID)
                                 ON DELETE CASCADE,
                                 CONSTRAINT VOTE_POOL_CANDIDATE_ID_FK 
	...
	CREATE TABLE VOTE_COUNT(CANDIDATE_ID                NUMBER,
                                       ...
                                       CONSTRAINT VOTE_COU_CANDIDATE_ID_PK 
                                       PRIMARY KEY(CANDIDATE_ID),
                                       CONSTRAINT    VOTE_COU_CANDIDATE_ID_FK 
                                       FOREIGN KEY(CANDIDATE_ID) 
                                       REFERENCES CANDIDATE(CANDIDATE_ID)
                                       ON DELETE CASCADE,
                                       CONSTRAINT VOTE_COU_ELECTION_ID_FK 
                                       FOREIGN KEY(ELECTION_ID) 
                                       REFERENCES ELECTION(ELECTION_ID)
                                       ON DELETE CASCADE);
  

CREATE TABLE LEGISLATIVE_VOTED_POPULATION
(
Constituency_id number,
Election_id varchar(32) NOT NULL,
...
CREATE TABLE LOKSHABA_VOTED_POPULATION
(
...
CREATE TABLE LEGISLATIVE_RESULT
(
Candidate_id number,
party_id number NOT NULL,
