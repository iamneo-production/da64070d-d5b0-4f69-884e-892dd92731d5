...
DESC FETCH FIRST 5 ROWS ONLY;
 ...
 SELECT ST_NAME ,SUM(TOTVOTPOLL) AS VOTES 
...
select round(sum(TOTVOTPOLL)/sum(ELECTORS)*100,2)  as percentage 

from election 

where year=2003 and st_name='Goa' and partyabbre='BJP';
...
and sum(TOTVOTPOLL)/(ELECTORS) * 100 > 50;
