...
SELECT ST_NAME ,SUM(TOTVOTPOLL) AS VOTES FROM ELECTION WHERE YEAR = 1987 AND PARTYABBRE = 'BJP' 
GROUP BY ST_NAME;
...
group by st_name
 ...
 select * from ELECTION where year=1987;
...
select round(sum(TOTVOTPOLL)/sum(ELECTORS)*100,2) 
